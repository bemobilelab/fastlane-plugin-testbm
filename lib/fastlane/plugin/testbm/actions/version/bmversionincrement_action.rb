    ...
    module Actions
        class BmversionincrementAction < Action
            ...
            def self.run(params)
                ...
                versionNumber = Helper::BmVersion::get_info_plist_value(project_information: project_information, key: "CFBundleShortVersionString")
                puts "######################## versionNumber: #{versionNumber} ############"

                Helper::BmVersion::version_func_update_build_number(other_action: other_action, project_information: project_information, platform_type: Helper::BmHelper::CONST_PROJECT_TYPE__IOS)
